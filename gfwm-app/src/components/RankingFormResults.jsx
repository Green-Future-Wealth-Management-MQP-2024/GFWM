      ...
      <table className="min-w-full bg-white">
        <thead>
          <tr>
            ...
            <th className="py-2 px-4 border-b-2 border-gray-300 text-left leading-4 text-gray-600 tracking-wider">Risk (0-100)</th>
        ...
        <tbody>
          {Object.values(data).map((item) => (
            <tr key={item.ticker} className="hover:bg-gray-100">
              ...
              <td className="py-2 px-4 border-b border-gray-300">{item.risk}</td>
