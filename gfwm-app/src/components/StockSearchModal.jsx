            ...
            <tbody>
              {sortedStocks.map((stock, index) =>{
                ...
                <tr key={stock.ticker} className="hover:bg-gray-100  ">
                  ...
                  <td className="py-1 px-2 border-b border-gray-300 cursor-pointer" onClick={() => onClickStock(stock.ticker)}>{stock.esg_combined.toFixed(2)}</td>
                <td className="py-1 px-2 border-b border-gray-300 cursor-pointer" onClick={() => onClickStock(stock.ticker)}>{stock.compatibility.toFixed(0)}%</td>
