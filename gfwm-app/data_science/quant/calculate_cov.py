...
price_data = pd.read_csv("data_science/quant/sp500_weekly_data.csv", parse_dates=["Date"])[['Date', 'ticker', 'log_return']]
...
price_data = price_data.pivot(index = 'week', columns='ticker', values='log_return')

# pandas covariance function
covariance_matrix = price_data.cov()

covariance_matrix.to_csv("data_science/quant/sp500_weekly_covariance_matrix.csv", index=True)
